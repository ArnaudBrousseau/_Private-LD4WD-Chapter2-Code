  ...
  switch(result.type){
      ...
      case 'release-group link':
        ...
        if(musicBrainzFound){
          ...
          errorMessage += 'Good news is you can help build a better web by contributing to MusicBrainz. Get started <a href="http://musicbrainz.org/doc/How_To_Contribute">here</a>, don\'t be shy :)</p>'
